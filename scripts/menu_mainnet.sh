...
case $choice in
    ...
    3) echo "Mockup Token"
        ...
        sixnftd tx nftmngr create-metadata "${schema_code}" ${token_id} --from klaytntest --gas auto --gas-adjustment 1.5 --gas-prices 0.1usixnft -y --node https://sixnft-rpc.sixprotocol.net:443 --keyring-backend file \
            ${BASE64_META}
        ;;
    4) echo "Do Action"
        read -p "Enter Schema Code: " schema_code 
        ...
        sixnftd tx nftmngr perform-action-by-nftadmin ${schema_code} ${token_id} ${action} --from klaytntest --gas auto --gas-adjustment 1.5 --gas-prices 0.1usixnft -y --node https://sixnft-rpc.sixprotocol.net:443 --keyring-backend file
        ;;
    5) echo "Set NFT Attribute"
        ...
        sixnftd tx nftmngr set-nft-attribute ${schema_code} ${BASE64_ATTR} --from klaytntest --gas auto --gas-adjustment 1.5 --gas-prices 0.1usixnft -y --node https://sixnft-rpc.sixprotocol.net:443
        ;;
    6) echo "Oracle - Create Mint Request"
        ...
        sixnftd tx nftoracle create-mint-request ${schema_code} ${token_id} ${require_confirmations} --from klaytntest --gas auto --gas-adjustment 1.5 --gas-prices 0.1usixnft -y --node https://sixnft-rpc.sixprotocol.net:443
        ;;
    ...
    8) echo "Oracle - Submit Mint Response"
        ...
        sixnftd tx nftoracle submit-mint-response ${mint_request_id} ${BASE64_ORIGINDATA} --from ${oracle_key_name} --gas auto --gas-adjustment 1.5 --gas-prices 0.1usixnft -y --node https://sixnft-rpc.sixprotocol.net:443
        ;;
    *) echo "Invalid choice"
       ;;
esac