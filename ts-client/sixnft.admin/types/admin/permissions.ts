...
export interface Permissions {
  mapName: { [key: string]: AddressList };
}
...
export const Permissions = {
  ...
  fromJSON(object: any): Permissions {
    const message = { ...basePermissions } as Permissions;
    message.mapName = {};
    if (object.mapName !== undefined && object.mapName !== null) {
      Object.entries(object.mapName).forEach(([key, value]) => {
        message.mapName[key] = AddressList.fromJSON(value);
      });
    }
    return message;
  },
  ...
  toJSON(message: Permissions): unknown {
    ...
    if (message.mapName) {
      Object.entries(message.mapName).forEach(([k, v]) => {
        obj.mapName[k] = AddressList.toJSON(v);
      });
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<Permissions>): Permissions {
    ...
    if (object.mapName !== undefined && object.mapName !== null) {
      Object.entries(object.mapName).forEach(([key, value]) => {
        if (value !== undefined) {
          message.mapName[key] = AddressList.fromPartial(value);
        }
      });
    }
    return message;
