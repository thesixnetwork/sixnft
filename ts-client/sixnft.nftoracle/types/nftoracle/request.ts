...
const baseNftOriginData: object = { image: "", holderAddress: "" };
...
export const NftOriginData = {
  ...
  fromJSON(object: any): NftOriginData {
    ...
    if (object.holderAddress !== undefined && object.holderAddress !== null) {
      message.holderAddress = String(object.holderAddress);
    } else {
  ...
  toJSON(message: NftOriginData): unknown {
    ...
    message.holderAddress !== undefined &&
...
export const DataHash = {
  ...
  fromJSON(object: any): DataHash {
    ...
    if (object.originData !== undefined && object.originData !== null) {
      message.originData = NftOriginData.fromJSON(object.originData);
    } else {
  ...
  toJSON(message: DataHash): unknown {
    ...
    message.originData !== undefined &&
      (obj.originData = message.originData
        ? NftOriginData.toJSON(message.originData)
        : undefined);
  ...
  fromPartial(object: DeepPartial<DataHash>): DataHash {
    ...
    message.confirmers = [];
    if (object.originData !== undefined && object.originData !== null) {
      message.originData = NftOriginData.fromPartial(object.originData);
    } else {
      message.originData = undefined;
    }
    if (object.hash !== undefined && object.hash !== null) {
