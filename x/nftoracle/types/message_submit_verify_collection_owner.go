...
func NewMsgSubmitVerifyCollectionOwner(creator string, verifyRequestID uint64, schemaCode string, contractOwnerAddress string) *MsgSubmitVerifyCollectionOwner {
