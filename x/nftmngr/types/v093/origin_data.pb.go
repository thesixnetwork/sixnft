...
type OriginData struct {
	...
	AttributeOverriding   AttributeOverriding    `protobuf:"varint,4,opt,name=attribute_overriding,json=attributeOverriding,proto3,enum=thesixnetwork.sixnft.nftmngr.v093.AttributeOverriding" json:"attribute_overriding,omitempty"`
	...
	UriRetrievalMethod    URIRetrievalMethod     `protobuf:"varint,7,opt,name=uri_retrieval_method,json=uriRetrievalMethod,proto3,enum=thesixnetwork.sixnft.nftmngr.v093.URIRetrievalMethod" json:"uri_retrieval_method,omitempty"`
}
...
func init() {
	proto.RegisterEnum("thesixnetwork.sixnft.nftmngr.v093.AttributeOverriding", AttributeOverriding_name, AttributeOverriding_value)
	proto.RegisterEnum("thesixnetwork.sixnft.nftmngr.v093.URIRetrievalMethod", URIRetrievalMethod_name, URIRetrievalMethod_value)
	proto.RegisterType((*OriginData)(nil), "thesixnetwork.sixnft.nftmngr.v093.OriginData")
}
...
var fileDescriptor_88b5ea7279bbd2ce = []byte{
	...
	0x90, 0x8d, 0x28, 0x54, 0xe2, 0x98, 0xb4, 0x05, 0x22, 0x44, 0x22, 0x19, 0x7a, 0xe1, 0x62, 0x6d,
	...
	0xed, 0xfd, 0xd3, 0x04, 0x79, 0x92, 0x0f, 0xfd, 0x91, 0x49, 0x83, 0x2b, 0x3d, 0x82, 0xa2, 0x47,
	0x70, 0x11, 0x54, 0x17, 0xcb, 0x9f, 0xcf, 0x55, 0x66, 0xef, 0x76, 0xd8, 0xb0, 0x37, 0x7a, 0xf8,
	0x33, 0x00, 0x00, 0xff, 0xff, 0x20, 0x50, 0x68, 0x4f, 0x11, 0x03, 0x00, 0x00,
}
