...
func init() {
	proto.RegisterType((*MapTokenToMinter)(nil), "thesixnetwork.sixnft.nftmngr.v093.MapTokenToMinter")
	proto.RegisterType((*MetadataCreator)(nil), "thesixnetwork.sixnft.nftmngr.v093.MetadataCreator")
}
...
var fileDescriptor_4fd5e8b657566487 = []byte{
	...
	0x00, 0xff, 0xff, 0x20, 0xd0, 0xad, 0x29, 0x82, 0x01, 0x00, 0x00,
}
