...
type FeeDistribution struct {
	Method  FeeDistributionMethod `protobuf:"varint,1,opt,name=method,proto3,enum=thesixnetwork.sixnft.nftmngr.v094.FeeDistributionMethod" json:"method,omitempty"`
...
func init() {
	proto.RegisterEnum("thesixnetwork.sixnft.nftmngr.v094.FeeDistributionMethod", FeeDistributionMethod_name, FeeDistributionMethod_value)
	proto.RegisterType((*FeeDistribution)(nil), "thesixnetwork.sixnft.nftmngr.v094.FeeDistribution")
	proto.RegisterType((*FeeConfig)(nil), "thesixnetwork.sixnft.nftmngr.v094.FeeConfig")
	proto.RegisterType((*NFTFeeConfig)(nil), "thesixnetwork.sixnft.nftmngr.v094.NFTFeeConfig")
}
...
var fileDescriptor_ba2cda3bf4b38ef2 = []byte{
	...
	0x00, 0xff, 0xff, 0xca, 0x6d, 0x7c, 0x76, 0x4a, 0x02, 0x00, 0x00,
}
