...
func init() {
	proto.RegisterType((*NFTSchemaByContract)(nil), "thesixnetwork.sixnft.nftmngr.v094.NFTSchemaByContract")
}
...
var fileDescriptor_d2518749f51be707 = []byte{
	...
	0x00, 0x00, 0xff, 0xff, 0x5a, 0xcc, 0x58, 0x2d, 0x15, 0x01, 0x00, 0x00,
}
