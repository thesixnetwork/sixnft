...
type NFTSchemaByContract struct {
	...
	SchemaCodes           []string `protobuf:"bytes,3,rep,name=schemaCodes,proto3" json:"schemaCodes,omitempty"`
}
...
func (m *NFTSchemaByContract) GetChain() string {
	if m != nil {
		return m.Chain
	}
	return ""
...
var fileDescriptor_3fab44ff2fe54bff = []byte{
	...
	,
}
...
func (m *NFTSchemaByContract) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Chain) > 0 {
		i -= len(m.Chain)
		copy(dAtA[i:], m.Chain)
		i = encodeVarintNftSchemaByContract(dAtA, i, uint64(len(m.Chain)))
		i--
		dAtA[i] = 0x12
	}
