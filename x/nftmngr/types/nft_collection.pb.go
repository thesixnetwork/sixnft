...
type NftCollection struct {
	...
	NftCount      uint64     `protobuf:"varint,2,opt,name=nftCount,proto3" json:"nftCount,omitempty"`
	NftData       []*NftData `protobuf:"bytes,3,rep,name=nftData,proto3" json:"nftData,omitempty"`
}
...
func (m *NftCollection) GetNftCount() uint64 {
	if m != nil {
		return m.NftCount
	}
	return 0
...
func (m *NftCollection) GetNftData() []*NftData {
	if m != nil {
		return m.NftData
	}
	return nil
...
var fileDescriptor_512bb9d739eee40d = []byte{
	...
	0xc4, 0x90, 0xf5, 0xa6, 0x24, 0x96, 0x24, 0x42, 0x74, 0x29, 0x4d, 0x62, 0xe4, 0xe2, 0xf5, 0x4b,
	0x2b, 0x71, 0x86, 0x9b, 0x26, 0xa4, 0xc2, 0xc5, 0x9b, 0x97, 0x56, 0x12, 0x9c, 0x9c, 0x91, 0x9a,
	0x9b, 0xe8, 0x9c, 0x9f, 0x92, 0x2a, 0xc1, 0xa8, 0xc0, 0xa8, 0xc1, 0x19, 0x84, 0x2a, 0x28, 0x24,
	0xc5, 0xc5, 0x91, 0x07, 0xd2, 0x56, 0x9a, 0x57, 0x22, 0xc1, 0xa4, 0xc0, 0xa8, 0xc1, 0x12, 0x04,
	0xe7, 0x0b, 0xd9, 0x73, 0xb1, 0xe7, 0xa5, 0x95, 0xb8, 0x24, 0x96, 0x24, 0x4a, 0x30, 0x2b, 0x30,
	0x6b, 0x70, 0x1b, 0xa9, 0xea, 0xe1, 0x73, 0x9b, 0x9e, 0x1f, 0x44, 0x71, 0x10, 0x4c, 0x97, 0x93,
	...
	0x94, 0x26, 0xe9, 0x25, 0xe7, 0xe7, 0xea, 0xa3, 0x98, 0xa9, 0x0f, 0x31, 0x53, 0xbf, 0x42, 0x1f,
	0xe6, 0xd1, 0x92, 0xca, 0x82, 0xd4, 0xe2, 0x24, 0x36, 0xb0, 0x37, 0x8d, 0x01, 0x01, 0x00, 0x00,
	0xff, 0xff, 0x68, 0xb3, 0x37, 0x00, 0x3c, 0x01, 0x00, 0x00,
}
...
func (m *NftCollection) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.NftCount != 0 {
		i = encodeVarintNftCollection(dAtA, i, uint64(m.NftCount))
		i--
		dAtA[i] = 0x10
	}
...
func (m *NftCollection) Size() (n int) {
	...
	if m.NftCount != 0 {
		n += 1 + sovNftCollection(uint64(m.NftCount))
	}
	if len(m.NftData) > 0 {
