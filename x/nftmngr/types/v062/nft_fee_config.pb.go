...
type FeeDistribution struct {
	Method  FeeDistributionMethod `protobuf:"varint,1,opt,name=method,proto3,enum=thesixnetwork.sixnft.nftmngr.v062.FeeDistributionMethod" json:"method,omitempty"`
...
func init() {
	proto.RegisterEnum("thesixnetwork.sixnft.nftmngr.v062.FeeDistributionMethod", FeeDistributionMethod_name, FeeDistributionMethod_value)
	proto.RegisterType((*FeeDistribution)(nil), "thesixnetwork.sixnft.nftmngr.v062.FeeDistribution")
	proto.RegisterType((*FeeConfig)(nil), "thesixnetwork.sixnft.nftmngr.v062.FeeConfig")
	proto.RegisterType((*NFTFeeConfig)(nil), "thesixnetwork.sixnft.nftmngr.v062.NFTFeeConfig")
}
...
var fileDescriptor_8d35653e84f6f7eb = []byte{
	...
	0x00, 0xff, 0xff, 0xdb, 0x21, 0x2a, 0x93, 0x4a, 0x02, 0x00, 0x00,
}
