...
func init() {
	proto.RegisterType((*MapTokenToMinter)(nil), "thesixnetwork.sixnft.nftmngr.v090.MapTokenToMinter")
	proto.RegisterType((*MetadataCreator)(nil), "thesixnetwork.sixnft.nftmngr.v090.MetadataCreator")
}
...
var fileDescriptor_e3cdfe80d9b9f2cf = []byte{
	...
	0x00, 0xff, 0xff, 0xe2, 0xfa, 0x08, 0x4e, 0x82, 0x01, 0x00, 0x00,
}
