...
type FeeDistribution struct {
	Method  FeeDistributionMethod `protobuf:"varint,1,opt,name=method,proto3,enum=thesixnetwork.sixnft.nftmngr.v090.FeeDistributionMethod" json:"method,omitempty"`
...
func init() {
	proto.RegisterEnum("thesixnetwork.sixnft.nftmngr.v090.FeeDistributionMethod", FeeDistributionMethod_name, FeeDistributionMethod_value)
	proto.RegisterType((*FeeDistribution)(nil), "thesixnetwork.sixnft.nftmngr.v090.FeeDistribution")
	proto.RegisterType((*FeeConfig)(nil), "thesixnetwork.sixnft.nftmngr.v090.FeeConfig")
	proto.RegisterType((*NFTFeeConfig)(nil), "thesixnetwork.sixnft.nftmngr.v090.NFTFeeConfig")
}
...
var fileDescriptor_f522059561b01f33 = []byte{
	...
	0x00, 0xff, 0xff, 0x9c, 0x43, 0xc9, 0xbd, 0x4a, 0x02, 0x00, 0x00,
}
