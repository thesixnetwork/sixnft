...
type FeeDistribution struct {
	Method  FeeDistributionMethod `protobuf:"varint,1,opt,name=method,proto3,enum=thesixnetwork.sixnft.nftmngr.v092.FeeDistributionMethod" json:"method,omitempty"`
...
func init() {
	proto.RegisterEnum("thesixnetwork.sixnft.nftmngr.v092.FeeDistributionMethod", FeeDistributionMethod_name, FeeDistributionMethod_value)
	proto.RegisterType((*FeeDistribution)(nil), "thesixnetwork.sixnft.nftmngr.v092.FeeDistribution")
	proto.RegisterType((*FeeConfig)(nil), "thesixnetwork.sixnft.nftmngr.v092.FeeConfig")
	proto.RegisterType((*NFTFeeConfig)(nil), "thesixnetwork.sixnft.nftmngr.v092.NFTFeeConfig")
}
...
var fileDescriptor_ac2853d979bbe8f8 = []byte{
	...
	0x00, 0xff, 0xff, 0xb7, 0xd4, 0x13, 0xd8, 0x4a, 0x02, 0x00, 0x00,
}
