...
type NftData struct {
	...
	OwnerAddressType  OwnerAddressType     `protobuf:"varint,4,opt,name=owner_address_type,json=ownerAddressType,proto3,enum=thesixnetwork.sixnft.nftmngr.v092.OwnerAddressType" json:"owner_address_type,omitempty"`
...
func init() {
	proto.RegisterEnum("thesixnetwork.sixnft.nftmngr.v092.OwnerAddressType", OwnerAddressType_name, OwnerAddressType_value)
	proto.RegisterType((*NftData)(nil), "thesixnetwork.sixnft.nftmngr.v092.NftData")
}
...
var fileDescriptor_194d7f991209bf8d = []byte{
	...
	0xe2, 0x90, 0xa0, 0x6e, 0x17, 0x24, 0x2e, 0x85, 0x4e, 0x28, 0x12, 0xca, 0xa4, 0x74, 0x70, 0xe0,
	...
	0x65, 0xd6, 0x7b, 0x1c, 0xfe, 0x02, 0x00, 0x00,
}
