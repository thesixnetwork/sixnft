...
func init() {
	proto.RegisterType((*MapTokenToMinter)(nil), "thesixnetwork.sixnft.nftmngr.v092.MapTokenToMinter")
	proto.RegisterType((*MetadataCreator)(nil), "thesixnetwork.sixnft.nftmngr.v092.MetadataCreator")
}
...
var fileDescriptor_3f9ed29c750b3ce1 = []byte{
	...
	0x00, 0xff, 0xff, 0xa1, 0xcb, 0xe1, 0xbd, 0x82, 0x01, 0x00, 0x00,
}
