...
func init() {
	proto.RegisterType((*MapTokenToMinter)(nil), "thesixnetwork.sixnft.nftmngr.v072.MapTokenToMinter")
	proto.RegisterType((*MetadataCreator)(nil), "thesixnetwork.sixnft.nftmngr.v072.MetadataCreator")
}
...
var fileDescriptor_2f91746e02d2e4cc = []byte{
	...
	0x00, 0xff, 0xff, 0x23, 0x2e, 0x82, 0x5d, 0x82, 0x01, 0x00, 0x00,
}
