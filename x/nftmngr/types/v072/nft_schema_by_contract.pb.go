...
func init() {
	proto.RegisterType((*NFTSchemaByContract)(nil), "thesixnetwork.sixnft.nftmngr.v072.NFTSchemaByContract")
}
...
var fileDescriptor_dd15db7cd8c861cf = []byte{
	...
	0x00, 0x00, 0xff, 0xff, 0x02, 0x25, 0x31, 0x31, 0x15, 0x01, 0x00, 0x00,
}
