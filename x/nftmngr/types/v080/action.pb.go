...
type Action struct {
	...
	AllowedActioner AllowedActioner `protobuf:"varint,6,opt,name=allowed_actioner,json=allowedActioner,proto3,enum=thesixnetwork.sixnft.nftmngr.v080.AllowedActioner" json:"allowed_actioner,omitempty"`
...
func init() {
	proto.RegisterEnum("thesixnetwork.sixnft.nftmngr.v080.AllowedActioner", AllowedActioner_name, AllowedActioner_value)
	proto.RegisterType((*ActionParams)(nil), "thesixnetwork.sixnft.nftmngr.v080.action_params")
	proto.RegisterType((*Action)(nil), "thesixnetwork.sixnft.nftmngr.v080.Action")
}
...
var fileDescriptor_a64699820cdb692b = []byte{
	...
	0xe2, 0x60, 0x47, 0x81, 0x03, 0x57, 0x17, 0x7c, 0x40, 0x32, 0x8e, 0xe4, 0x04, 0x50, 0xb9, 0x58,
	...
	0x61, 0x1b, 0x14, 0x13, 0xdd, 0x02, 0x00, 0x00,
}
