...
type FeeDistribution struct {
	Method  FeeDistributionMethod `protobuf:"varint,1,opt,name=method,proto3,enum=thesixnetwork.sixnft.nftmngr.v080.FeeDistributionMethod" json:"method,omitempty"`
...
func init() {
	proto.RegisterEnum("thesixnetwork.sixnft.nftmngr.v080.FeeDistributionMethod", FeeDistributionMethod_name, FeeDistributionMethod_value)
	proto.RegisterType((*FeeDistribution)(nil), "thesixnetwork.sixnft.nftmngr.v080.FeeDistribution")
	proto.RegisterType((*FeeConfig)(nil), "thesixnetwork.sixnft.nftmngr.v080.FeeConfig")
	proto.RegisterType((*NFTFeeConfig)(nil), "thesixnetwork.sixnft.nftmngr.v080.NFTFeeConfig")
}
...
var fileDescriptor_181e3be05bbfb5a0 = []byte{
	...
	0x00, 0xff, 0xff, 0x57, 0x51, 0x1d, 0x06, 0x4a, 0x02, 0x00, 0x00,
}
