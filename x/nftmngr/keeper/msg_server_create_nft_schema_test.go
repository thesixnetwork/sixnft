...
func TestCreateSchema(t *testing.T) {
	...
	_ = keeper.MergeAllSchemaAttributesAndAlterOrderIndex(schema.OriginData.OriginAttributes, schema.OnchainData.NftAttributes, schema.OnchainData.TokenAttributes)
