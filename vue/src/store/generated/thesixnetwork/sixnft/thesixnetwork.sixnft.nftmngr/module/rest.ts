...
export interface NftmngrNftCollection {
  nftSchemaCode?: string;
...
export interface NftmngrQueryAllNftCollectionResponse {
  nftCollection?: NftmngrNftCollection[];
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   *
   * @tags Query
   * @name QueryNftCollectionAll
   * @summary Queries a list of NftCollection items.
   * @request GET:/thesixnetwork/sixnft/nftmngr/nft_collection
   */
  queryNftCollectionAll = (
    query?: {
      "pagination.key"?: string;
      "pagination.offset"?: string;
      "pagination.limit"?: string;
    ...
    this.request<NftmngrQueryAllNftCollectionResponse, GooglerpcStatus>({
      path: `/thesixnetwork/sixnft/nftmngr/nft_collection`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   */
  queryNftCollection = (nftSchemaCode: string, params: RequestParams = {}) =>
