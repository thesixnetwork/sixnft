...
import { MsgHidddenAttributes } from "./types/nftmngr/tx";
...
const types = [
  ...
  ["/thesixnetwork.sixnft.nftmngr.MsgHidddenAttributes", MsgHidddenAttributes],
...
const txClient = async (wallet: OfflineSigner, { addr: addr }: TxClientOptions = { addr: "http://localhost:26657" }) => {
  ...
  return {
    ...
    msgHidddenAttributes: (data: MsgHidddenAttributes): EncodeObject => ({ typeUrl: "/thesixnetwork.sixnft.nftmngr.MsgHidddenAttributes", value: MsgHidddenAttributes.fromPartial( data ) }),
