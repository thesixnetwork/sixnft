...
export interface EvmsupportAddressBinding {
  ethAddress?: string;
  nativeAddress?: string;
}

export interface EvmsupportMsgBindAddressResponse {
  ethAddress?: string;
  nativeAddress?: string;
}
 ...
 */
export type EvmsupportParams = object;

export interface EvmsupportQueryAllAddressBindingResponse {
  addressBinding?: EvmsupportAddressBinding[];
...
export interface EvmsupportQueryGetAddressBindingResponse {
  addressBinding?: EvmsupportAddressBinding;
}
...
/**
 * @title evmsupport/address_binding.proto
